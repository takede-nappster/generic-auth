...
describe('Bundle Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'bundle', component: BundleComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bundles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
