...
export class BundleComponent implements OnInit {
  ...
  trackId(_index: number, item: IBundle): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBundle[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
