...
describe('AdditionalData Management Component', () => {
  let comp: AdditionalDataComponent;
  let fixture: ComponentFixture<AdditionalDataComponent>;
  let service: AdditionalDataService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'additional-data', component: AdditionalDataComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AdditionalDataComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.additionalData?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
