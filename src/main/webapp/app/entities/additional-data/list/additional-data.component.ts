...
export class AdditionalDataComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.additionalDataService
      ...
      .subscribe({
        next: (res: HttpResponse<IAdditionalData[]>) => {
  ...
  trackId(_index: number, item: IAdditionalData): number {
    return item.id!;
  }

  delete(additionalData: IAdditionalData): void {
    const modalRef = this.modalService.open(AdditionalDataDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IAdditionalData[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
