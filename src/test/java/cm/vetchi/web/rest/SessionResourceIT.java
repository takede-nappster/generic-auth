...
class SessionResourceIT {
    ...
    public static Session createEntity(EntityManager em) {
        Session session = new Session().startDate(DEFAULT_START_DATE).endDate(DEFAULT_END_DATE);
        return session;
    }
    ...
    public static Session createUpdatedEntity(EntityManager em) {
        Session session = new Session().startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
        return session;
    }
    ...
    void putNewSession() throws Exception {
        ...
        updatedSession.startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
    ...
    void partialUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.endDate(UPDATED_END_DATE);
    ...
    void fullUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
